...
# то вывести в консоль ('Переменная item_4 = ', item_5), иначе,
...
# 31. Внутри if currency_convertor сделать следующие If условия:
    ...
    # 31.8 Последним оставить else, при выполнении которого в консоль выведется ('Unknow currency')
    else:
        print('Unknow currency')
# 30. ...иначе, вывести в консоль ('Переменная currency_convertor = ', item_3)
else:
